...
import { createCategoryAction, createDishAction, deleteDishAction, updateDishAction, type DishInput } from "@/lib/actions/menu";
import { LayoutGrid, List, Plus, Search, SlidersHorizontal, MoreVertical, Pencil, Trash2 } from "lucide-react";

export function ManageDishesClient({ categories, dishes }: { categories: Category[]; dishes: Dish[] }) {
